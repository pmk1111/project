...
private int comment_i_num;
private int comment_p_num;
...
public int getComment_i_num() {
	return comment_i_num;
}
public void setComment_i_num(int comment_i_num) {
	this.comment_i_num = comment_i_num;
}
public int getComment_p_num() {
	return comment_p_num;
}
public void setComment_p_num(int comment_p_num) {
	this.comment_p_num = comment_p_num;
}
