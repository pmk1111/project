...
@WebServlet("*.pro")
public class ProjectFrontController extends javax.servlet.http.HttpServlet {
	   ...
	   protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      /*
	       ...
	       예) contextPath가 "/JspProject"인 경우
	          http://localhost:8088/JspProject/BoardList.bo인 경우 "/JspProject/BoardList.bo" 반환됩니다.
	       */
	      ...
	      switch (command) {
	         case "/ProjectList.pro":
	            action = new ProjectListAction();
	            break;
	         case "/ProjectCreate.pro":
	            action = new ProjectCreateAction();
	            break;
	         case "/ProjectAddAction.pro":
	        	 action = new ProjectAddAction();
	            break;
	         case "/ProjectMainboard.pro":
	        	 action = new ProjectMainboardAction();
	            break;
//	         case "/BoardList.bo":
...
//	            break;
	         case "/ProjectModifyView.pro":
	            ...
	            break;
	         case "/ProjectModifyAction.pro":
	        	 action = new ProjectModifyAction();
	            break;
	         case "/ProjectDeleteAction.pro":
	        	 action = new ProjectDeleteAction();
	        	 break;
				/* 혜원(8/12) */
	         case "/ProjectoutAction.pro":
	        	 action = new ProjectoutAction();
	        	 break;
