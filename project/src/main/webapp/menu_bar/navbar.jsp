...
<body>
    ...
    <div class="nav_bar">
      <a href="home.net"><img class="logo" src="img/logo.png" alt="메인 로고"></a>
      <div id="search">
        ...
        <li>
          <div class="uicon-dropdown">
            ...
            <div class="uicon-dropdown-item">
              <a id="mypage" name="mypage" href="usrEdit.net">마이페이지</a>
              <a id="logout" name="logout" href="home.net">로그아웃</a>
            </div>
          </div>
        </li>
      </ul>
