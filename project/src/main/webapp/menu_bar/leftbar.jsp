...
<div class="left-bar">
	...
	<div class="left-bar-items">
		...
		<label for="create_pj"><a href="ProjectCreate.pro">프로젝트
				생성하기</a></label>
	</div>
	<div class="left-bar-items">
	...
	<div class="left-bar-items">
		<img id="issue_all" class="left-menu-icon" src="img/news.svg"> <label
			for="issue_all"><a href="IssueList.bo?num=${p_num }">전체
				이슈</a></label>
	</div>
	...
	<h5>일정</h5>
	<div class="left-bar-items">
		<img id="main_board" class="left-menu-icon" src="img/new.svg"> <label
			for="main_board"><a href="ProjectMainboard.pro?num=${p_num }">메인보드</a></label>
	</div>
	...
	<div class="left-bar-items">
		<img id="code" class="left-menu-icon" src="img/code-alt.svg"> <label
			for="code">코드</label>
	</div>
	...
	<div class="left-bar-items">
		<img id="fav_page" class="left-menu-icon" src="img/Star.svg"> <label
			for="fav_page">즐겨찾는 페이지</label>
	</div>
	<div class="left-bar-items">
		<img id="pj_setting" class="left-menu-icon" src="img/settings.svg">
		<label for="pj_setting"><a
			href="ProjectModifyView.pro?num=${p_num }">프로젝트 설정</a></label>
	</div>

	<div class="left-bar-items">
		<img id="pj_setting" class="left-menu-icon" src="img/people.svg">
		<label for="pj_member"><a href="MemberList.mem?num=${p_num }">프로젝트
				멤버</a></label>
	</div>

	<div class="left-bar-items">
		<img id="add_team" class="left-menu-icon" src="img/person-add.svg">
		<label for="add_team"><a href="MemberInvite.mem?num=${p_num }">팀원
				초대하기</a></label>
	</div>
	<br>
	<br>
